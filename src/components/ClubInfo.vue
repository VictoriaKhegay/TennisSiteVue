<template>
  <div class="cort-club-wrapper">
    <div class="cort-club-info">
      <h2>Петербургский теннисный клуб имени М.А. Пасечникова</h2>
...
@Component
export default class ClubInfoComponent extends Vue {}
</script>
...
.cort-club-wrapper {
  ...
  &::before {
    ...
    width: 526px;
    height: 514px;
    background-image: url("../assets/img/clubinfo.jpg");
